...
<body style="color: #fff !important;font-weight:bolder;margin: 0 !important;font-weight: bolder !important;font-family: 'Courier New', Courier, monospace;">
    <div style="background-color: #042A38;height: auto;">
        <div class="navbar" style="display: inline-flex;width: 100%;color:#042A38;position:fixed;">
            <section style="margin: 1.5vw;">DEPARTMENT QUIZ MANAGEMENT</section>
        ...
        ?>
        <center><section style="width:100vw;margin:0vw;margin-top:5vw;font-size:3vw;">Welcome to Depatment Quiz System &nbsp;<?php echo $dbname ?></section></center>
...
"function dash(){".
    ...
    "}".
"function lo(){".
"alert(\"Thank You for Using our Department quiz management System\");";
//session_unset();
//session_destroy();
