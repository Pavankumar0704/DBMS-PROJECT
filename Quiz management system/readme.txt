...
step 5: copy the "DBMS-MINI_PROJECT" at C://xampp/htdocs and then extract here.
step 6: visit localhost/phpmyadmin and create a new database named "db_test".
step 7: select "DBMS-MINI_PROJECT"  and import db_test.sql file here.
step 8:visit localhost/DBMS-MINI_PROJECT for user panel.
step 9: Signup If user doesnot have account registered.or login with username and password[User having account].
