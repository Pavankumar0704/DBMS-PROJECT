...
<head>
    <title>
        Deapartment Quiz managment System
    </title>
...
<body style="margin: 0 !important;font-weight: bolder !important;font-family: 'Courier New', Courier, monospace;height:auto;color:#fff">
    <div id="main" style="background-color: #042A38;height: auto;color:#fff !important">
        <div class="navbar" style="display: inline-flex;width: 100%;color:#042A38;position:fixed;">
            <section style="margin: 1.5vw;">DEPARTMENT QUIZ MANAGEMNET</section>
        ...
        <center><section style="width:100vw;margin:0vw;margin-top:4vw;font-size:2vw;">Welcome to DEAPARTEMENT QUIZ MANAGEMENT SYSTEM&nbsp;<?php echo $dbname ?></section></center>
...
echo '<script>' .
    ...
    "}" .
    "function lo(){" .
    "alert(\"Thank You for Using Depatemnt Quiz Management System\");";
    //session_unset();
//session_destroy();
